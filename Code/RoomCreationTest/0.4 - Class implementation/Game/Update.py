...
def Update():
    ...
    if data["gameState"] == "Select" and gameState.state != "Select": gameState = gameState_Select()
    if data["gameState"] == "CreateRoom" and gameState.state != "CreateRoom": gameState = gameState_CreateRoom()
    if data["gameState"] == "ImportRoom" and gameState.state != "ImportRoom": gameState = gameState_ImportRoom()
