...
# = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = #
                ...
                def Run_BlitSetup_RenderLayer_tile(self,tile):
                    title = ""
                    for i in range(len(tile)-1): title += tile[i+1] + "_"
                    title = title[:-1]

                    if len(tile) <= 7 and self.asset[tile[0]].get(title) == None:
                            if len(tile) == 7: 
                                self.asset[tile[0]][title] =  pygame.image.load(f"{self.local}/assets/{tile[0]}/{tile[1]}/{tile[2]}.png")
                                Run_BlitSetup_ChangeHue(self.asset[tile[0]][title],f"{tile[3]}_{tile[4]}_{tile[5]}_{tile[6]}",True)
                            elif len(tile) == 8: 
                                if tile[0] != "sprite": self.asset[tile[0]][title] =  pygame.image.load(f"{self.local}/assets/{tile[0]}/{tile[1]}/{tile[2]}_{tile[3]}.png")
                                else: self.asset[tile[0]][title] =  pygame.image.load(f"{self.local}/assets/{tile[0]}/{tile[1]}_{tile[2]}_{tile[3]}.png")
                                Run_BlitSetup_ChangeHue(self.asset[tile[0]][title],f"{tile[4]}_{tile[5]}_{tile[6]}_{tile[7]}",True)

                    if tile[1] != "decor" and tile[0] != "sprite": surface.blit(self.asset[tile[0]][title],((x*self.displayData["tileSize"])+self.gridData["offsetX"],(y*self.displayData["tileSize"])+self.gridData["offsetY"]))
                    elif tile[0] != "sprite": surface.blit(self.asset[tile[0]][title],((x*self.displayData["tileSize"])+self.gridData["offsetX"]-math.floor((self.decorTileDimentionsArray[tile[2]][0]-1)*(self.displayData["tileSize"]/2)),(y*self.displayData["tileSize"])+self.gridData["offsetY"]-math.floor((self.decorTileDimentionsArray[tile[2]][1]-1)*(self.displayData["tileSize"]))))
                    else: self.surface.blit(self.asset[tile[0]][title],(math.floor(((x*self.displayData["tileSize"])+8)-(self.asset[tile[0]][title].get_width()/2)),((y*self.displayData["tileSize"])+12)-self.asset[tile[0]][title].get_height()))
...
# = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = #
                ...
                for y in range(self.displayData["height"]+1):
                    ...
                    for x in range(self.displayData["width"]+1):
                        ...
                        elif tile[0] == "tile" or tile[0] == "sprite": Run_BlitSetup_RenderLayer_tile(self,tile)
                        elif tile[0] == "pco":
                            if pco_check != True: 
