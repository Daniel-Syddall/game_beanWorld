...
temp_Variables_fileStore = temp_Variables_fileStore[0]
temp_Variables_fileStore = temp_Variables_fileStore.split("-")
display["grid"]["scale"] = int(temp_Variables_fileStore[1])
...
fontArray = pygame.font.get_fonts()
h1 = pygame.font.SysFont(fontArray[2], 6*display["grid"]["scale"])
h2 = pygame.font.SysFont(fontArray[2], 5*display["grid"]["scale"])
p = pygame.font.SysFont(fontArray[2], 4*display["grid"]["scale"])
...
if data["varInit"] == False:
    ...
    for i in range(5):
        ...
        temp_Variables_fileStore = temp_Variables_fileStore[0]
        temp_Variables_fileStore = temp_Variables_fileStore.split("-")
        if temp_Variables_fileStore[0] == "sprite": player["sprite"] = temp_Variables_fileStore[1]
        elif temp_Variables_fileStore[0] == "room": grid["room"] = temp_Variables_fileStore[1]
        elif temp_Variables_fileStore[0] == "roomX": player["roomX"] = ((int(temp_Variables_fileStore[1]))*16)+9
        elif temp_Variables_fileStore[0] == "roomY": player["roomY"] = ((int(temp_Variables_fileStore[1]))*16)+9
