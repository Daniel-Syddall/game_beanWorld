...
# - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - #
    ...
    for i in range(6):
        ...
        Room_ChangeState(self,roomName[i],"pass",1,1,15,11)
        ...
        for l in range(6): Room_ChangeHue(self,roomName[i],l,0,0,16,19,f"{hueChange[i][0]}_{hueChange[i][1]}_{hueChange[i][2]}_0")
