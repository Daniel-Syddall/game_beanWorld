...
# = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = #
        ...
        self.gridData = {"room" : "room0","lockXL" : False,"lockXR" : False,"lockYL" : False,"lockYR" : False,"offsetX" : 0,"offsetY" : 0,
        "startX":0,"startY":0}
...
# = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = #
        ...
        self.asset = {"sprite":{},"character":{},"tile":{},"decor":{},"type":{},"pco":{},"overlay":{},"shadow":{},"opening":pygame.image.load(f"{self.local}/assets/opening.png"),"textBox":pygame.image.load(f"{self.local}/assets/textBox.png"),"border":pygame.image.load(f"{self.local}/assets/border.png")}
...
# = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = #
            ...
            if self.controller["sprint"] == True: self.player["movementSpeed"] = 2  # SPRINT SPEED MODIFIER #
...
# = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = #
        ...
        if self.init == False:
            ...
            #Sets up the prev Width Check for Opening Screen
            self.opening_prevWidth = None
            ...
            self.player["room"] = "room0"
            Run_GetSpriteDimensions(self)
            self.player["roomX"] = 132
...
# = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = #
    ...
    def Blit(self,surface,x,y,width,height): 
        ...
        elif self.opening_prevWidth != width: 
            surface.blit(pygame.transform.scale(self.asset["border"],(surface.get_width(),surface.get_height())),(0,0))
            surface.blit(pygame.transform.scale(self.asset["opening"],(width,height)),(x,y))
        self.opening_prevWidth = width
