                    ...
                    for x in range(self.displayData["width"]+1):
                        ...
                        if tile != "":
                            ...
                            if tile[0] == "rgba": 
                                ...
                                elif tile [0] != "pco": surface.blit(self.asset[tile[0]][temp_title],((x*self.displayData["tileSize"])+self.gridData["offsetX"],(y*self.displayData["tileSize"])+self.gridData["offsetY"]))
                                else:
                                    if pco_check != True: 
