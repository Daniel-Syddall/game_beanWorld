...
class Map:
    ...
    def __init__(self,app):
        ...
        app.fps = 60
        self.state = "Map"
        self.textBox = Widget_Label(app,"h2","","black",app.w(20),app.w(80),app.h(80),app.h(97),"white","black")
    ...
    def blit(self):
        temp_surfaceX,temp_surfaceY,temp_surfaceWidth,temp_surface_height = rpg.Blit(self.app.window,math.floor((self.app.w(100)-((self.app.height/13)*17))/2),self.app.h(0),(self.app.height/13)*17,self.app.height)
        if rpg.textBox != "":
            self.textBox.update_dimentions(temp_surfaceX+self.app.w(5),temp_surfaceX+temp_surfaceWidth-self.app.w(5),temp_surfaceY+self.app.h(85),temp_surfaceY+temp_surface_height-self.app.h(3))
            self.textBox.blit()
