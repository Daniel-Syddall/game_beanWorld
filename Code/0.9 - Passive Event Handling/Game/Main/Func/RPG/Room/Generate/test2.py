...
def test2(self):
    ...
    for i in range(20): Room_CreateEvent(self,"test2",test2_event_0(self),i,"passive")
    for i in range(20): Room_CreateEvent(self,"test2",test2_event_1(self),i+20,"passive")