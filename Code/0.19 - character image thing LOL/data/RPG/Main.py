...
# = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = #
        ...
        self.asset = {"sprite":{},"character":{},"tile":{},"decor":{},"type":{},"pco":{},"textBox":pygame.image.load(f"{self.local}/assets/textBox.png"),"border":pygame.image.load(f"{self.local}/assets/border.png")}
