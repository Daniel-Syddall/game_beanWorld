...
# = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = - = #
        ...
        groundTileTypeArray = ["full","left","up","down","right","left+up","up+right","right+down","down+left","left+right","up+down","left+up+right","up+right+down","left+right+down","left+up+down","left+up+right+down"]
